...
<head>
    ...
    <title>New Booking Request - Fort Breeze Hotel</title>
    <!-- Bootstrap CSS -->
    <link
...
<body>
    <div class="email-container">
        ...
        <div class="content-section">
            <h2 class="h4 text-center mb-4" style="color: #2a5555">
                <i class="fas fa-calendar-check me-2"></i>New Booking Request
            </h2>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <p class="info-value">{{ $data['service'] }}</p>
                </div>
            </div>

            <div class="mb-4">
                <p class="info-label">Booking Date:</p>
                <p class="info-value">{{ $data['date'] }}</p>
            </div>

            @if(!empty($data['message']))
            <div class="mb-4">
                <p class="info-label">Additional Message:</p>
    ...
    <!-- Bootstrap JS (optional for email) -->
